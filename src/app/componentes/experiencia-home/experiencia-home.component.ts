...
@Component({
  selector: 'app-experiencia-home',
  templateUrl: './experiencia-home.component.html',
  styleUrls: ['./experiencia-home.component.css']
})
export class ExperienciaHomeComponent implements OnInit {
